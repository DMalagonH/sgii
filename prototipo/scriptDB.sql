...
-- Procedimientos
--
CREATE  PROCEDURE `SPR_DEL_PERFIL_MODULO`(IN `PI_PER_NID` BIGINT(20), IN `PI_MOD_NID` BIGINT(20))
    NO SQL
...
CREATE  PROCEDURE `SPR_DEL_USARIO_PROYECTO`(IN`PI_USU_NID` BIGINT,IN`PI_PRO_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_AUDITORIA_BY_ID`(IN `PI_NID_AUDITORIA` BIGINT)
    NO SQL
SELECT AUD_NID,AUD_CTABLE,AUD_CCOLUMN,AUD_COLD_VALUE,AUD_CNEW_TABLE,AUD_DDATE_TRANSACTION,USU_NID
...
CREATE  PROCEDURE `SPR_GET_ESTADO_HIPOTESIS_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_HIPOTESIS_BY_ID`(IN`PI_NID_ESTADO_HIPOTESIS` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_OBJETIVO_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_OBJETIVO_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_OBJETIVO_BY_ID`(IN`PI_NID_ESTADO_OBJETIVO` BIGINT( 20))
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_PROYECTO_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_PROYECTO_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_ESTADO_PROYECTO_BY_ID`(IN `PI_NID_ESTADO_PROYECTO` BIGINT)
    NO SQL
SELECT EPR_NID,EPR_CESTADO_PROYECTO,EPR_OESTADO
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_ALL_ACTIVE`()
    NO SQL
SELECT HER_NID, HER_CNOMBRE_HERRAMIENTA, HER_DFECHA_INICIO, HER_DFECHA_FIN, THE_NID, HER_OESTADO
FROM tbl_therramienta
WHERE HER_OESTADO =1$$

CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_BY_ID`(IN`PI_HER_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_BY_THE`(IN`PI_THE_NID` BIGINT( 20))
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_PROYECTO_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_PROYECTO_ALL_ACTIVE`()
    NO SQL
SELECT UHP_NID,HER_NID,PRO_NID
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_PROYECTO_BY_ID`(IN `PI_NID_HERRAMIENTA_PROYECTO` BIGINT)
    NO SQL
SELECT UHP_NID,HER_NID,PRO_NID
...
CREATE  PROCEDURE `SPR_GET_HERRAMIENTA_PROYECTO_BY_PRO`(IN`PI_PRO_NID` BIGINT( 20))
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HIPOTESIS_BY_EHI`(IN`PI_EHI_NID` BIGINT( 20))
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HIPOTESIS_BY_ID`(IN `PI_NID_HIPOTESIS` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_HIPOTESIS_BY_PROYECTO`(IN `PI_NID_PROYECTO` BIGINT(20))
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_LINEA_INVESTIGACION_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_LINEA_INVESTIGACION_ALL_ACTIVE`()
    NO SQL
    COMMENT 'selecciona todos los registros de la tbl linea de investigacion '
SELECT LIN_NID, LIN_CNOMBRE_INVESTIGACION, LIN_OESTADO
FROM tbl_rlinea_investigacion
...
CREATE  PROCEDURE `SPR_GET_LINEA_INVESTIGACION_BY_ID`(IN `PI_NID_LINEA_INVESTIGACION` BIGINT)
    NO SQL
SELECT LIN_NID,LIN_CNOMBRE_INVESTIGACION,LIN_OESTADO
...
CREATE  PROCEDURE `SPR_GET_LOG_ALL`()
    NO SQL
SELECT LOG_NID,LOG_DFECHA,USU_NID,LOG_IP,LOG_HOST

FROM tbl_alog$$

CREATE  PROCEDURE `SPR_GET_LOG_ALL_ACTIVE`()
    NO SQL
SELECT LOG_NID,LOG_DFECHA,USU_NID,LOG_IP,LOG_HOST
...
CREATE  PROCEDURE `SPR_GET_LOG_BY_ID`(IN `PI_NID_LOG` BIGINT)
    NO SQL
SELECT LOG_NID,LOG_DFECHA,USU_NID,LOG_IP,LOG_HOST
...
CREATE  PROCEDURE `SPR_GET_MODULO_ALL`()
    NO SQL
SELECT MOD_NID,MOD_CNOMBRE,MOD_OESTADO

FROM tbl_rmodulo$$

CREATE  PROCEDURE `SPR_GET_MODULO_ALL_ACTIVE`()
    NO SQL
SELECT MOD_NID,MOD_CNOMBRE,MOD_OESTADO
...
CREATE  PROCEDURE `SPR_GET_MODULO_BY_ID`(IN `PI_NID_MODULO` BIGINT)
    NO SQL
SELECT MOD_NID,MOD_CNOMBRE,MOD_OESTADO
...
CREATE  PROCEDURE `SPR_GET_OBJETIVO_ALL`()
    NO SQL
SELECT OBJ_NID,OBJ_COBJETIVO,OBJ_NID_PADRE,OBJ_OESTADO,PRO_NID,EOB_NID

FROM tbl_robjetivo$$

CREATE  PROCEDURE `SPR_GET_OBJETIVO_ALL_ACTIVE`()
    NO SQL
SELECT OBJ_NID,OBJ_COBJETIVO,OBJ_NID_PADRE,OBJ_OESTADO,PRO_NID,EOB_NID
...
CREATE  PROCEDURE `SPR_GET_OBJETIVO_BY_ID`(IN `PI_NID_OBJETIVO` BIGINT)
    NO SQL
SELECT OBJ_NID,OBJ_COBJETIVO,OBJ_NID_PADRE,OBJ_OESTADO,PRO_NID,EOB_NID
...
CREATE  PROCEDURE `SPR_GET_PERFIL_ALL`()
    NO SQL
SELECT PER_NID,PER_CPERFIL,PER_OESTADO

FROM tbl_rperfil$$

CREATE  PROCEDURE `SPR_GET_PERFIL_ALL_ACTIVE`()
    NO SQL
SELECT PER_NID,PER_CPERFIL,PER_OESTADO
...
CREATE  PROCEDURE `SPR_GET_PERFIL_BY_ID`(IN `PI_NID_PERFIL` BIGINT)
    NO SQL
SELECT PER_NID,PER_CPERFIL,PER_OESTADO
...
CREATE  PROCEDURE `SPR_GET_PERFIL_MODULO_ALL`()
    NO SQL
SELECT UPM_NID,PER_NID,MOD_NID

FROM tbl_uperfil_modulo$$

CREATE  PROCEDURE `SPR_GET_PERFIL_MODULO_ALL_ACTIVE`()
    NO SQL
SELECT UPM_NID,PER_NID,MOD_NID
...
CREATE  PROCEDURE `SPR_GET_PERFIL_MODULO_BY_ID`(IN `PI_NID_PERFIL_MODULO` BIGINT)
    NO SQL
SELECT UPM_NID,PER_NID,MOD_NID
...
CREATE  PROCEDURE `SPR_GET_PREGUNTA_ALL`()
    NO SQL
SELECT PRE_NID,PRE_CPREGUNTA,PRE_OOBLIGATORIA,PRE_OESTADO,HER_NID,TPR_NID

FROM tbl_rpregunta$$

CREATE  PROCEDURE `SPR_GET_PREGUNTA_ALL_ACTIVE`()
    NO SQL
SELECT PRE_NID,PRE_CPREGUNTA,PRE_OOBLIGATORIA,PRE_OESTADO,HER_NID,TPR_NID
...
CREATE  PROCEDURE `SPR_GET_PREGUNTA_BY_ID`(IN `PI_NID_PREGUNTA` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_PROYECTO_BY_USER`(IN `PI_NID_USER` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_PROYECTO_BY_USER_ACTIVE`(IN `PI_NID_USER` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_PROYECTO_BY_USER_ACTIVE_CLOSED`(IN `PI_NID_USER` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_PROYECTO_INVESTIGACION_ALL`()
    NO SQL
SELECT PRO_NID,
PRO_CNOMBRE,
PRO_CDESCRIPCION,
...
CREATE  PROCEDURE `SPR_GET_PROYECTO_INVESTIGACION_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_PROYECTO_INVESTIGACION_BY_ID`(IN `PI_NID_PROYECTO_INVESTIGACION` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_RESPUESTA_ALL`()
    NO SQL
SELECT RES_NID,RES_CRESPUESTA,RES_OESTADO,PRE_NID

FROM tbl_rrespuesta$$

CREATE  PROCEDURE `SPR_GET_RESPUESTA_ALL_ACTIVE`()
    NO SQL
SELECT RES_NID,RES_CRESPUESTA,RES_OESTADO,PRE_NID
...
CREATE  PROCEDURE `SPR_GET_RESPUESTA_BY_ID`(IN `PI_NID_RESPUESTA` BIGINT)
    NO SQL
SELECT RES_NID,RES_CRESPUESTA,RES_OESTADO,PRE_NID
...
CREATE  PROCEDURE `SPR_GET_RESULTADO_BY_ID`(IN `PI_NID_RESULTADO` BIGINT)
    NO SQL
SELECT RST_NID,RST_DFECHA,RST_OESTADO,USU_NID,RST_CPREGUNTA_TEXTUAL,RST_CRESPUESTA_TEXTUAL
...
CREATE  PROCEDURE `SPR_GET_TIPO_HERRAMIENTA_ALL`()
    NO SQL
SELECT THE_NID,THE_CNOMBRE_HERRAMIENTA,THE_OESTADO

FROM tbl_rtipo_herramienta$$

CREATE  PROCEDURE `SPR_GET_TIPO_HERRAMIENTA_ALL_ACTIVE`()
    NO SQL
SELECT THE_NID,THE_CNOMBRE_HERRAMIENTA,THE_OESTADO
...
CREATE  PROCEDURE `SPR_GET_TIPO_HERRAMIENTA_BY_ID`(IN `PI_NID_TIPO_HERRAMIENTA` BIGINT)
    NO SQL
SELECT THE_NID,THE_CNOMBRE_HERRAMIENTA,THE_OESTADO
...
CREATE  PROCEDURE `SPR_GET_TIPO_INVESTIGACION_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_TIPO_INVESTIGACION_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_TIPO_INVESTIGACION_BY_ID`(IN`PI_TIN_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_TIPO_PREGUNTA_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_TIPO_PREGUNTA_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_TIPO_PREGUNTA_BY_ID`(IN`PI_NID_TIPO_PREGUNTA` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USARIO_PROYECTO_BY_PRO`(IN`PI_PRO_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USARIO_PROYECTO_BY_USU`(IN`PI_USU_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USARIO_PROYECTO_EXIST`(IN`PI_USU_NID` BIGINT,IN`PI_PRO_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USUARIO_ALL`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USUARIO_ALL_ACTIVE`()
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USUARIO_BY_ID`(IN`PI_NID_USUARIO` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USUARIO_BY_LOG`(IN`PI_CLOG` VARCHAR( 250) ,IN`PI_CPASSWORD` VARCHAR( 250))
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USUARIO_PERFIL_BY_PER`(IN`PI_PER_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_GET_USUARIO_PERFIL_BY_USU`(IN`PI_USU_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_ESTADO_HIPOTESIS`(IN`PI_EHI_CESTADO_HIPOTESIS` VARCHAR( 250) ,IN`PI_EHI_OESTADO` BOOLEAN )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_ESTADO_OBJETIVO`(IN`PI_CESTADO_OBJETIVO` VARCHAR( 250) ,IN`PI_EOB_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_ESTADO_PROYECTO`(IN`PI_EPR_CESTADO_PROYECTO` VARCHAR( 250) ,IN`PI_EPR_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_HERRAMIENTA`(IN`PI_HER_CNOMBRE_HERRAMIENTA` VARCHAR( 250) ,IN`PI_ER_DFECHA_INICIO` DATETIME,IN`PI_HER_DFECHA_FIN` DATETIME,IN`PI_THE_NID` BIGINT( 20) ,IN`PI_HER_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_HIPOTESIS`(IN`PI_HIP_CHIPOTESIS` VARCHAR( 250) ,IN`PI_HIP_OESTADO` TINYINT( 1) ,IN`PI_PRO_NID` BIGINT( 20) ,IN`PI_EHI_NID` BIGINT( 20))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_LINEA_INVESTIGACION`(IN`PI_LIN_CNOMBRE_INVESTIGACION` VARCHAR( 250) ,IN`PI_LIN_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_LOG`( IN  `PI_USU_NID_LOG` BIGINT( 20 ) , IN  `PI_IP_LOG` VARCHAR( 50 ) , IN  `PI_HOST_LOG` VARCHAR( 50 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_MODULO`( IN  `PI_CNOMBRE_MOD` VARCHAR( 255 ) , IN  `PI_OESTADO_MOD` TINYINT( 6 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_OBJETIVO`( IN  `PI_COBJETIVO` VARCHAR( 250 ) , IN  `PI_NID_PADRE` BIGINT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) , IN  `PI_PRO_NID` BIGINT( 20 ) , IN  `PI_EOB_NID` BIGINT( 20 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_PERFIL`( IN  `PI_CPERFIL_PERFIL` VARCHAR( 250 ) , IN  `PI_OESTADO_PERFIL` TINYINT( 1 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_PERFIL_MODULO`( IN  `PI_PER_NID` BIGINT( 20 ) , IN  `PI_MOD_NID` BIGINT( 20 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_PREGUNTA`( IN  `PI_CPREGUNTA` VARCHAR( 250 ) , IN  `PI_OOBLIGATORIA` TINYINT( 1 ) , IN  `PI_OESTADO` TINYINT( 1 ) , IN  `PI_HER_NID` BIGINT( 20 ) , IN  `PI_TPR_NID` BIGINT( 20 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_PROYECTO`(IN `PI_CNOMBRE` VARCHAR(250), IN `PI_CDESCRIPCION` VARCHAR(2500), IN `PI_CPROBLEMA` VARCHAR(500), IN `PI_NID_USU` BIGINT, IN `PI_NID_EPR` BIGINT, IN `PI_NID_LIN` BIGINT, IN `PI_NID_TIN` BIGINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_RESPUESTA`( IN  `PI_CRESPUESTA` VARCHAR( 250 ) , IN  `PI_OESTADO` TINYINT( 1 ) , IN  `PI_PRE_NID` BIGINT( 20 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_RESULTADO`( IN  `PI_OESTADO` TINYINT( 1 ) , IN  `PI_USU_NID` BIGINT( 20 ) , IN  `PI_CPREGUNTA_TEXTUAL` VARCHAR( 2500 ) , IN `PI_CRESPUESTA_TEXTUAL` VARCHAR( 2500 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_TIPO_INVESTIGACION`(IN`PI_TIN_CNOMBRE_TIPO` VARCHAR( 250) ,IN`PI_TIN_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_TIPO_PREGUNTA`(IN`PI_TPR_CTIPO_PREGUNTA` VARCHAR( 250) ,IN`PI_TPR_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_USARIO_PROYECTO`(IN`PI_USU_NID` BIGINT,IN`PI_PRO_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_USUARIO`(IN`PI_USU_CCEDULA` VARCHAR( 20) ,IN`PI_USU_CNOMBRE` VARCHAR( 250) ,IN`PI_USU_NID_HOMOLOGO` BIGINT,IN`PI_USU_CLOG` VARCHAR( 250) ,IN`PI_USU_CPASSWORD` VARCHAR( 250) ,IN`PI_USU_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_INS_USUARIO_PERFIL`(IN`PI_USU_NID` BIGINT,IN`PI_PER_NID` BIGINT )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_ESTADO_HIPOTESIS`(IN`PI_EHI_NID` BIGINT( 20) ,IN`PI_EHI_CESTADO_HIPOTESIS` VARCHAR( 250) ,IN`PI_EHI_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_ESTADO_HIPOTESIS_ACT_INA`(IN`PI_EHI_NID` BIGINT( 20) ,IN`PI_EHI_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_ESTADO_OBJETIVO`(IN`PI_EOB_NID` BIGINT( 20) ,IN`PI_EOB_CESTADO_OBJETIVO` VARCHAR( 250) ,IN`PI_EOB_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_ESTADO_OBJETIVO_ACT_INA`(IN`PI_EOB_NID` BIGINT,IN`PI_EOB_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_ESTADO_PROYECTO`(IN`PI_EPR_NID` BIGINT,IN`PI_EPR_CESTADO_PROYECTO` VARCHAR( 250) ,IN`PI_EPR_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_ESTADO_PROYECTO_ACT_INA`(IN`PI_EPR_NID` BIGINT,IN`PI_EPR_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_HERRAMIENTA`(IN`PI_HER_NID` BIGINT( 20) ,IN`PI_HER_CNOMBRE_HERRAMIENTA` VARCHAR( 250) ,IN`PI_HER_DFECHA_INICIO` DATETIME,IN`PI_HER_DFECHA_FIN` DATETIME,IN`PI_HER_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_HIPOTESIS`(IN `PI_HIP_NID` BIGINT(20), IN `PI_HIP_CHIPOTESIS` VARCHAR(250), IN `PI_HIP_OESTADO` TINYINT(1), IN `PI_PRO_NID` BIGINT(20), IN `PI_EHI_NID` BIGINT(20))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_HIPOTESIS_SEGUIMIENTO`(IN `PI_HIP_NID` BIGINT(20), IN `PI_EHI_NID` BIGINT(20), IN `PI_CSEGUIMIENTO` LONGTEXT)
    NO SQL
    COMMENT 'actualiza un registro de la tabla hipotesis'
UPDATE tbl_thipotesis 
SET  
...
CREATE  PROCEDURE `SPR_UPD_LINEA_INVESTIGACION`(IN`PI_LIN_NID` BIGINT( 20) ,IN`PI_LIN_CNOMBRE_INVESTIGACION` VARCHAR( 250) ,IN`PI_LIN_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_LINEA_INVESTIGACION_ACT_INA`(IN`PI_LIN_NID` BIGINT( 20) ,IN`PI_LIN_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_MODULO`( IN  `PI_NID_MOD` BIGINT( 20 ) , IN  `PI_CNOMBRE_MOD` VARCHAR( 255 ) , IN  `PI_OESTADO_MOD` TINYINT( 6 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_MODULO_ACT_INA`( IN  `PI_NID_MOD` BIGINT( 20 ) , IN  `PI_OESTADO_MOD` TINYINT( 6 ) )
    NO SQL
UPDATE tbl_rmodulo SET MOD_OESTADO = PI_OESTADO_MOD WHERE MOD_NID = PI_NID_MOD$$

CREATE  PROCEDURE `SPR_UPD_OBJETIVO`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_COBJETIVO` VARCHAR( 250 ) , IN  `PI_OESTADO` TINYINT( 1 ) , IN  `PI_EOB_NID` BIGINT( 20 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_OBJETIVO_ACT_INA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
    COMMENT 'ACTUALIZAR  ESTADO'
UPDATE tbl_robjetivo SET OBJ_OESTADO = PI_OESTADO WHERE OBJ_NID = PI_NID$$

CREATE  PROCEDURE `SPR_UPD_PERFIL`( IN  `PI_NID_PERFIL` BIGINT( 20 ) , IN  `PI_CPERFIL_PERFIL` VARCHAR( 250 ) , IN  `PI_OESTADO_PERFIL` TINYINT( 1 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_PERFIL_ACT_INA`( IN  `PI_NID_PERFIL` INT( 20 ) , IN  `PI_OESTADO_PERFIL` TINYINT( 6 ) )
    NO SQL
    COMMENT 'Inactivar perfil'
UPDATE tbl_rperfil SET PER_OESTADO = PI_OESTADO_PERFIL WHERE PER_NID = PI_NID_PERFIL$$

CREATE  PROCEDURE `SPR_UPD_PREGUNTA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_CPREGUNTA` VARCHAR( 250 ) , IN  `PI_OOBLIGATORIA` TINYINT( 1 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_PREGUNTA_ACT_INA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
    COMMENT 'Actualizar estado de la pregunta'
UPDATE tbl_rpregunta SET PRE_OESTADO = PI_OESTADO WHERE PRE_NID = PI_NID$$

CREATE  PROCEDURE `SPR_UPD_PREGUNTA_OBLIG`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_OOBLIGATORIA` TINYINT( 1 ) )
    NO SQL
    COMMENT 'Actualizar obligatoriedad'
UPDATE tbl_rpregunta SET PRE_OOBLIGATORIA = PI_OOBLIGATORIA WHERE PRE_NID = PI_NID$$

CREATE  PROCEDURE `SPR_UPD_PROYECTO`(IN `PI_CNOMBRE` VARCHAR(250), IN `PI_CDESCRIPCION` VARCHAR(2500), IN `PI_CPROBLEMA` VARCHAR(500), IN `PI_NID_USU` BIGINT, IN `PI_NID_EPR` BIGINT, IN `PI_NID_LIN` BIGINT, IN `PI_NID_TIN` BIGINT, IN `PI_NID_PRO` BIGINT, IN `PI_OESTADO` TINYINT)
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_PROYECTO_CIERRE`(IN `PI_CCONCLUCIONES` VARCHAR(2500), IN `PI_CDEMOSTRACIONES` VARCHAR(2500), IN `PI_CRECOMENDACIONES` VARCHAR(2500), IN `PI_NID_EPR` BIGINT, IN `PI_NID_PRO` BIGINT)
    NO SQL
UPDATE tbl_tproyecto_investigacion
...
CREATE  PROCEDURE `SPR_UPD_RESPUESTA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_CRESPUESTA` VARCHAR( 250 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
    COMMENT 'ACTUALIZAR ESTADO'
...
CREATE  PROCEDURE `SPR_UPD_RESPUESTA_ACT_INA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_RESULTADO`( IN  `PI_NID` INT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) , IN  `PI_USU_NID` BIGINT( 20 ) , IN  `PI_CPREGUNTA_TEXTUAL` VARCHAR( 2500 ) , IN  `PI_CRESPUESTA_TEXTUAL` VARCHAR( 2500 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_RESULTADO_ACT_INA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
    COMMENT 'Activa o inactiva el resultado'
UPDATE tbl_tresultado SET RST_OESTADO = PI_OESTADO WHERE RST_NID = PI_NID$$

CREATE  PROCEDURE `SPR_UPD_TIPO_HERRAMIENTA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_CNOMBRE_HERRAMIENTA` VARCHAR( 250 ) , IN `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_TIPO_HERRAMIENTA_ACT_INA`( IN  `PI_NID` BIGINT( 20 ) , IN  `PI_OESTADO` TINYINT( 1 ) )
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_TIPO_INVESTIGACION`(IN`PI_TIN_NID` BIGINT,IN`PI_TIN_CNOMBRE_TIPO` VARCHAR( 250) ,IN`PI_TIN_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_TIPO_INVESTIGACION_ACT_INA`(IN`PI_TIN_NID` BIGINT,IN`PI_TIN_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_TIPO_PREGUNTA`(IN`PI_TPR_NID` BIGINT,IN`TPR_CTIPO_PREGUNTA` VARCHAR( 250) ,IN`TPR_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_TIPO_PREGUNTA_ACT_INA`(IN`PI_TPR_NID` BIGINT,IN`PI_TPR_OESTADO` TINYINT( 1))
    NO SQL
...
CREATE  PROCEDURE `SPR_UPD_USUARIO`(IN`PI_USU_NID` BIGINT,IN`PI_USU_CCEDULA` VARCHAR( 20) ,IN`PI_USU_CNOMBRE` VARCHAR( 250) ,IN`PI_USU_NID_HOMOLOGO` BIGINT,IN`PI_USU_CLOG` VARCHAR( 250) ,IN`PI_USU_CPASSWORD` VARCHAR( 250) ,IN`PI_USU_OESTADO` TINYINT( 1))
    NO SQL
