...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_estado_proyecto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_linea_investigacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_tipo_investigacion` ;
...
CREATE  TABLE IF NOT EXISTS `tbl_niveles` (
  ...
  PRIMARY KEY (`id`) )
ENGINE = InnoDB
COMMENT = 'Tabla para nivel de cargo que el usuario (Operativo, directivo, tactico	)';
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_tipo_herramienta` ;
...
-- Table `tbl_hipotesis`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_hipotesis` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_perfil_modulo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_usuario_herramienta` ;
